...
// ===== PROYECTOS =====
const proyectos = [
    { id: 1, titulo: "Weather App", descripcion: "Aplicación del clima en tiempo real", descripcionLarga: "Aplicación completa del clima con datos en tiempo real, pronóstico de 5 días y mapa interactivo.", url: "#", github: "#", categoria: "javascript", tecnologias: ["JavaScript", "API REST", "CSS3"], imagen: "🌤️", fecha: "2024", desafio: "Manejar errores de API", solucion: "Implementé caching con localStorage", rol: "Frontend Developer" },
    { id: 2, titulo: "Task Manager", descripcion: "Gestor de tareas con LocalStorage", descripcionLarga: "Sistema completo de gestión de tareas con drag & drop, categorías y fechas.", url: "#", github: "#", categoria: "javascript", tecnologias: ["JavaScript", "LocalStorage", "CSS Grid"], imagen: "✅", fecha: "2024", desafio: "Sincronizar estado", solucion: "Patrón Observer", rol: "Full Stack Developer" },
    { id: 3, titulo: "Portfolio Dashboard", descripcion: "Dashboard con React y Chart.js", descripcionLarga: "Dashboard administrativo con gráficos en tiempo real y panel personalizable.", url: "#", github: "#", categoria: "react", tecnologias: ["React", "Chart.js", "Context API"], imagen: "📊", fecha: "2024", desafio: "Rendimiento", solucion: "Memoization", rol: "React Developer" },
    { id: 4, titulo: "Adivina el Número", descripcion: "Juego clásico de adivinanza. ¿Puedes encontrar el número secreto?", descripcionLarga: "Juego interactivo donde debes adivinar un número aleatorio entre 1 y 100. Recibirás pistas si tu número es muy alto o muy bajo. ¡Pon a prueba tu intuición!", url: "/JUEGOS/ADIVINA EL NUMERO/index.html", github: "#", categoria: "javascript", tecnologias: ["JavaScript", "HTML5", "CSS3", "DOM Manipulation"], imagen: "🎯", fecha: "2025", desafio: "Generar número aleatorio y dar retroalimentación al usuario", solucion: "Usé Math.random() para el número secreto y condicionales para las pistas", rol: "Frontend Developer"}
];
