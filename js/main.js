...
const proyectos = [
    ...
    { id: 3, titulo: "Love Map - Lima ↔ Milán", descripcion: "Mapa interactivo con playlist colaborativa de Spotify para una relación a distancia", descripcionLarga: "Una experiencia personalizada que combina un mapa interactivo mostrando la distancia entre Lima y Milán (11,043 km), un reloj en tiempo real con la hora en ambas ciudades, y una playlist colaborativa donde puedes agregar canciones de Spotify con solo pegar el enlace. Perfecto para mantener viva la conexión a pesar de la distancia.", url: "/Day/index.html", github: "#", categoria: "javascript", tecnologias: ["JavaScript", "Leaflet.js", "Spotify Embed API", "LocalStorage", "CSS3"], imagen: "🗺️💖", fecha: "2025", desafio: "Crear una experiencia personalizada para una relación a distancia que combine geolocalización, música y facilidad de uso", solucion: "Uso de Leaflet para el mapa interactivo, Spotify oEmbed para obtener información de canciones, y LocalStorage para persistencia de datos", rol: "Full Stack Developer"},
    { id: 6, titulo: "FanHub - Zully · GTA V · Minecraft", descripcion: "Web personalizada con la streamer favorita (Zully), tips de FiveM y Minecraft, pandas adorables y frases motivadoras", descripcionLarga: "Un espacio dedicado a sus gustos: Zully en Kick, comandos útiles para rolear en FiveM y sobrevivir en Minecraft, una galería de pandas interactiva y frases que la motivan. Todo con su color favorito: morado.", url: "/Fan Hub//index.html", github: "#", categoria: "javascript", tecnologias: ["JavaScript", "CSS Grid", "Diseño responsivo", "LocalStorage"], imagen: "🎮🐼", fecha: "2025", desafio: "Unificar varios gustos personales en una sola web cohesiva", solucion: "Secciones temáticas bien diferenciadas, diseño morado y experiencias interactivas", rol: "Frontend Developer" 
}
];
