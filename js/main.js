...
const galeria = [
    ...
    { titulo: "Juego de Memoria", icono: "🧠", descripcion: "Encuentra las parejas de emojis" },
    { titulo: "Portal de Soporte", icono: "📋", descripcion: "Respuestas rápidas y manuales PDF para atención al cliente" }
];
...
const proyectos = [
    ...
    { id: 5, titulo: "Juego de Memoria", descripcion: "Clásico juego de memoria con emojis, temporizador y contador de movimientos", descripcionLarga: "Encuentra todas las parejas de emojis en el menor tiempo posible. Incluye temporizador, contador de movimientos, reinicio y nueva partida. Interfaz colorida y responsive con animaciones fluidas.", url: "Memoria/index.html", github: "#", categoria: "javascript", tecnologias: ["JavaScript", "CSS Grid", "Animaciones CSS", "DOM Manipulation"], imagen: "🧠", fecha: "2026", desafio: "Sincronizar el estado del juego, manejar delays y bloquear interacciones durante animaciones", solucion: "Uso de gameLocked flag, setTimeout para delay y estados claros", rol: "Frontend Developer" },
    { id: 6, titulo: "Portal de Soporte", descripcion: "Sistema profesional con respuestas rápidas, manuales PDF, respaldos, edición y atajos de teclado", descripcionLarga: "Herramienta completa para atención al cliente: respuestas predefinidas con contador de usos, almacenamiento de PDFs, exportar/importar datos, búsqueda avanzada, ordenamiento, atajos de teclado y modo oscuro sincronizado.", url: "Portal Soporte/index.html", github: "#", categoria: "javascript", tecnologias: ["JavaScript", "LocalStorage", "File API", "PDF Embed"], imagen: "📋", fecha: "2026", desafio: "Crear una herramienta de soporte completa", solucion: "Gestión de respuestas + manuales + respaldos", rol: "Frontend Developer" }
];
